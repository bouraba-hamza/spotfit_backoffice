...
export const ROUTES: RouteInfo[] = [
    ...
    {
        path: '/dashboard/gyms', title: 'Gyms', icon: 'ft-layout', class: '', badge: '', badgeClass: '', isExternalLink: false, submenu: []
    },
    {
    ...
    {
        path: '/full-layout', title: 'Facturation', icon: 'ft-layout', class: '', badge: '', badgeClass: '', isExternalLink: false, submenu: []
    },
    {
